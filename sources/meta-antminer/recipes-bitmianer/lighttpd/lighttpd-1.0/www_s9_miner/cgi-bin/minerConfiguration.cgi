			...
			<div class="cbi-map" id="cbi-cgminer">
				...
				<fieldset class="cbi-section" id="cbi-cgminer-cgminer">
					...
					<fieldset class="cbi-section" id="cbi-cgminer-default" style="display:none">
						...
						<div class="cbi-value" id="economic">
							<label class="cbi-value-title" for="keep">Low Power Mode</label>
							<div class="cbi-value-field">
								<input type="checkbox" name="ant_economic_mode_check" id="ant_economic_mode" />
							</div>
						</div>
					</fieldset>
					<br />
